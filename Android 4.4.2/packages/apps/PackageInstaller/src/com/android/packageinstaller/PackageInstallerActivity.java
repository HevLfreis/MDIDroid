    ...
    public void onClick(View v) {
        if(v == mOk) {
            if (mOkCanInstall || mScrollView == null) {
                ...
                //newIntent.putExtra("DATA", mPackageURI);
                newIntent.setClass(this, InstallDomainActivity.class);
                ...
                newIntent.putExtra("installerPackageName", installerPackageName);
                newIntent.putExtra("mOriginatingURI", mOriginatingURI);
                newIntent.putExtra("mReferrerURI", mReferrerURI);
                newIntent.putExtra("mOriginatingUid", mOriginatingUid);
                newIntent.putExtra(Intent.EXTRA_RETURN_RESULT, getIntent().getBooleanExtra(Intent.EXTRA_RETURN_RESULT, false));
